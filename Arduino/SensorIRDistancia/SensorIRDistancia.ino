...
//ordem dos sensores da esuqerda para direita, logo o S1 é o sensor mais para a esquerda
int S1 = A0;
int S2 = A1;
int S3 = A2;
int S4 = A3;
...
void PID_control() {
  ...
  if ( && (digitalRead(S2) == 0) && (digitalRead(S3) == 0) && (digitalRead(S4) == 0) && (digitalRead(S5) == 0))
  {
    erro = -4;
  }
